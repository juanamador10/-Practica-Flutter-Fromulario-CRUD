  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder:
          ...
          // Si la Aplicacion se le da Continuar, Todo sigue con normalidad. (???)
...
class Calendario extends StatefulWidget {
  final String info;
  const Calendario({super.key, required this.info});
...
class GeneroDropdown extends StatefulWidget{
  String info;
  GeneroDropdown({super.key, required this.info});
